...
{
    this->peerHbStatus = other.peerHbStatus;
}

void Heartbeat::parsimPack(omnetpp::cCommBuffer *b) const
{
    doParsimPacking(b,this->peerHbStatus);
}

void Heartbeat::parsimUnpack(omnetpp::cCommBuffer *b)
{
    doParsimUnpacking(b,this->peerHbStatus);
}

bool Heartbeat::getPeerHbStatus() const
{
    return this->peerHbStatus;
}

void Heartbeat::setPeerHbStatus(bool peerHbStatus)
{
    this->peerHbStatus = peerHbStatus;
}
...
HeartbeatDescriptor::HeartbeatDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(inet::Heartbeat)), "")
{
...
unsigned int HeartbeatDescriptor::getFieldTypeFlags(int field) const
{
    ...
    static unsigned int fieldTypeFlags[] = {
        FD_ISEDITABLE,    // FIELD_peerHbStatus
    };
...
int HeartbeatDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0] == 'p' && strcmp(fieldName, "peerHbStatus") == 0) return base+0;
...
std::string HeartbeatDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    Heartbeat *pp = (Heartbeat *)object; (void)pp;
    switch (field) {
        case FIELD_peerHbStatus: return bool2string(pp->getPeerHbStatus());
        default: return "";
    }
}
...
bool HeartbeatDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    Heartbeat *pp = (Heartbeat *)object; (void)pp;
    switch (field) {
        case FIELD_peerHbStatus: pp->setPeerHbStatus(string2bool(value)); return true;
